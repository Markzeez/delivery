...
/**
 * Legacy /track-package route.
 * If a code is provided, redirects to the new /track/[trackingCode] route.
 * Otherwise shows the search form.
 */
export default function TrackPage({ searchParams }: TrackPageProps) {
  const code = searchParams.code?.trim();

  // Hard redirect to new dynamic route if code is present
  if (code) {
      ...
      <div className="mx-auto w-full max-w-4xl space-y-8">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <input
                ...
                name="code"
                type="text"
                placeholder="e.g. NG-LAG-2026-00001"
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          <p className="text-slate-600">
            Enter a tracking code above and press{" "}
            <strong>Track</strong> to view status, live map, and delivery
            updates.
          </p>
        </section>
      </div>
